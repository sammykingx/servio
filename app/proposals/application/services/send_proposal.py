...
class ProposalSubmissionService:
    ...
    def submit_proposal(self, payload: ProposalSubmissionPayload):
        ...
        try:
            ...
            project = self._create_proposal_bundle(payload)
    ...
    @transaction.atomic
    def _create_proposal_bundle(self, payload: ProposalSubmissionPayload) -> Model:
        """
    ...
    def _notify_creator_by_mail(self, project: ProjectEntity) -> None:
